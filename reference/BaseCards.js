...
(function (BaseCards) {
    BaseCards.WhiteCards = [
        ...
        "Crippling debt.", 
        "Daddy issues.", 
        "The Donald Trump Seal of Approval&reg;.", 
        ...
        "Domino's&reg; Oreo&reg; Dessert Pizza.", 
        "Kanye West.", 
        "Hot cheese.", 
        "Raptor attacks.", 
        ...
        "Dying of dysentery.", 
        "My inner demons.", 
        "A Super Soaker&reg; full of cat pee.", 
        "Aaron Burr.", 
        "Cuddling.", 
        "The chronic.", 
        "Cockfights.", 
        ...
        "The invisible hand.", 
        "Waiting â€˜til marriage.", 
        "Unfathomable stupidity.", 
        "Euphoria&reg; by Calvin Klein.", 
        "Re-gifting.", 
        "Autocannibalism.", 
        ...
        "The Tempur-Pedic Swedish Sleep System&reg;.", 
        "Dying.", 
        "Hurricane Katrina.", 
        "The gays.", 
        "The folly of man.", 
    ...
    BaseCards.MultiBlackCards = [
        {
            Line: "That's right, I killed __________. How, you ask? __________.",
            Conditions: [
                {
                    Condition: "Pick",
                    Value: "2"
        ...
        {
            Line: "And the Academy Award for __________ goes to __________.",
            Conditions: [
                {
                    Condition: "Pick",
                    Value: "2"
        ...
        {
            Line: "For my next trick, I will pull __________ out of __________.",
            Conditions: [
                {
                    Condition: "Pick",
                    Value: "2"
        ...
        {
            Line: "In his new summer comedy, Rob Schneider is __________ trapped in the body of __________.",
            Conditions: [
                {
                    Condition: "Pick",
                    Value: "2"
        ...
        {
            Line: "When I was tripping on acid, __________ turned into __________.",
            Conditions: [
                {
                    Condition: "Pick",
                    Value: "2"
        ...
        {
            Line: "__________ is a slippery slope that leads to __________.",
            Conditions: [
                {
                    Condition: "Pick",
                    Value: "2"
        ...
        {
            Line: "In a world ravaged by __________, our only solace is __________.",
            Conditions: [
                {
                    Condition: "Pick",
                    Value: "2"
        ...
        {
            Line: "In M. Night Shyamalan's new movie, Bruce Willis discovers that __________ had really been __________ all along.",
            Conditions: [
                {
                    Condition: "Pick",
                    Value: "2"
        ...
        {
            Line: "I never truly understood __________ until I encountered __________.",
            Conditions: [
                {
                    Condition: "Pick",
                    Value: "2"
        ...
        {
            Line: "Rumor has it that Vladimir Putin's favorite dish is __________ stuffed with __________.",
            Conditions: [
                {
                    Condition: "Pick",
                    Value: "2"
        ...
        {
            Line: "Lifetime&reg; presents __________, the story of __________.",
            Conditions: [
                {
                    Condition: "Pick",
                    Value: "2"
        ...
        {
            Line: "What's the next superhero/sidekick duo?",
            Conditions: [
                {
                    Condition: "Pick",
                    Value: "2"
        ...
        {
            Line: "______ + _______ = _____________.",
            Conditions: [
                {
                    Condition: "Draw",
                    Value: "2"
...
; ;
//@ sourceMappingURL=BaseCards.js.map
